...
Scenario:
A company wants to calculate employee salaries using inheritance. 
All employees have a base salary, but different roles calculate bonuses differently.
Requirements:
...
namespace ConsoleApp6
{
    ...
    class Employee
    {
        ...
        public virtual double CalculateSalary()     // Virtual Method
        {
            return BaseSalary;
        }
    }
    ...
    class Program
    {
        ...
        {
            Employee emp;     // Runtime Polymorphism
